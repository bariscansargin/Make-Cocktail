...
const CocktailLinkCard = ({ cocktail }) => {
  return (
    <Link
      ...
      className="flex flex-col bg-cyan-500 hover:bg-pink-300 hover:scale-110 transition duration-150  ease-in items-center justify-center w-48 h-128 mr-12 mb-12 shadow-2xl shadow-cyan-500 rounded-lg"
    >
