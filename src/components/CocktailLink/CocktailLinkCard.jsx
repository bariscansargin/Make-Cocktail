...
const CocktailLinkCard = ({ cocktail }) => {
  return (
    <Link
      ...
      className="flex flex-col  bg-[#B0DAB9] hover:bg-cyan-500 hover:shadow-cyan-500 hover:scale-110 transition duration-150  ease-in items-center justify-center w-48 h-128 mb-12 shadow-2xl shadow-gray-400 rounded-lg md:mr-8"
    >
