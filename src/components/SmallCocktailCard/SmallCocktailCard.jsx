...
const SmallCocktailCard = ({ cocktail, info, clickHandler }) => {
  return (
    <div className="flex flex-col items-center justify-center shadow-lg border-solid rounded-xl mb-12 bg-[#B0DAB9] p-12">
      ...
      <div className="flex mt-4 ">
        ...
        <Link>
          <ButtonComponent type={"red"} position={"ml-8  w-12 "}>
            &times;
          </ButtonComponent>
        </Link>
      </div>
